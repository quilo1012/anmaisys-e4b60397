...
BEGIN
  ...
  -- Same-line operator check: any operator account that has this WO's line in its line_ids
  ...
  -- Permission: admin, manager, original operator, or any operator on the same line
  IF NOT (
  ...
  RETURN jsonb_build_object(
    ...
    'reopen_count', _orig.current_episode
  );
END;
$function$;