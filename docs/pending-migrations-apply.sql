...
--
-- INCLUI, desde 17/08, o bloco 20260820090000 (filling_a_week_is_not_approving_it). Nao
-- cria nada: substitui a politica FOR ALL da de 15/08 por uma por verbo, para que
-- production_office_admin possa preencher uma semana e nao a possa aprovar, e estende o
-- trigger da CAPA para exigir que approved_by seja auth.uid() e que quem assina tenha
-- papel de aprovacao. Tem de vir DEPOIS da de 15/08 (e a politica e o trigger dessa que
-- ele reescreve); nao depende de mais nada.
--
-- AVISO: as duas de 18/08 e 19/08 foram escritas noutra sessao e NAO foram
