        ...
        <AuthProvider>
          <Suspense fallback={<PageLoader />}>
            <Routes>
              ...
              <Route path="/dashboard/analytics" element={<ProtectedRoute allowedRoles={["admin", "manager", "engineer"]}><AnalyticsPage /></ProtectedRoute>} />
              ...
              <Route path="/dashboard/downtime" element={<ProtectedRoute allowedRoles={["admin", "manager", "engineer"]}><DowntimePage /></ProtectedRoute>} />
              <Route path="/dashboard/reliability" element={<ProtectedRoute allowedRoles={["admin", "engineer"]}><ReliabilityDashboard /></ProtectedRoute>} />
