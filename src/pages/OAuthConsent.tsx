...
const consentBadge = (
  <span className="inline-flex shrink-0 items-center gap-1 rounded-full bg-sky-100 px-2 py-1 text-2xs font-medium uppercase tracking-wider text-sky-700 ring-1 ring-sky-200 sm:gap-1.5">
