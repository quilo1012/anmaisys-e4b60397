...
import { UserPlus, Shield, Wrench as WrenchIcon, HardHat } from "lucide-react";
...
export default function ManageUsers() {
  ...
  const handleCreateUser = async (e: React.FormEvent) => {
    ...
    try {
      // Create auth user via edge function (admin creates users)
      ...
      const res = await supabase.functions.invoke("create-user", {
        body: {
          ...
          name: name.trim(),
          role,
          shift: role === "engineer" ? shift : null,
        },
      });
