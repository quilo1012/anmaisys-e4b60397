...
const EXPECTED: Record<Action, Role[]> = {
  ...
  // planner.manage / sku.view are defined but unwired; planner editing and SKU
  // browsing are gated by planner.view and sku.manage respectively.
  "planner.manage": [],
  "sku.view": [],
  ...
  // smarttarget.view is defined but unwired (no Smart Target page checks it yet).
  "smarttarget.view": [],
