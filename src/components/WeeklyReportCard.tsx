...
export function WeeklyReportCard() {
  ...
  const cronSql = `-- Run weekly on Mondays at 08:00 UTC
select cron.schedule(
  'weekly-maintenance-report',
  '0 8 * * 1',
  $$
  select net.http_post(
    url:='https://${projectRef}.supabase.co/functions/v1/send-weekly-report',
  ...
  const sendNow = async () => {
    ...
    try {
      ...
      toast.success(`Weekly report sent to ${email}`);
    } catch (e: any) {
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Email a summary of the past 7 days — KPIs, top problem machines, PMs due. Optional: schedule automatic delivery.
        </CardDescription>
      </CardHeader>
