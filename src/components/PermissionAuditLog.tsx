                    ...
                    <TableRow key={row.id}>
                      ...
                      <TableCell>
                        <div className="flex items-center justify-center gap-1.5">
                          <Badge
                            variant="outline"
                            className={from === "allowed" ? "border-success/40 text-success-strong" : "border-border text-muted-foreground"}
                          >
                            {from || "—"}
                          </Badge>
                          ...
                          <Badge
                            variant="outline"
                            className={to === "allowed" ? "border-success/40 bg-success/10 text-success-strong" : "border-destructive/40 bg-destructive/5 text-destructive-strong"}
                          >
                            {to || "—"}
                          </Badge>
                          {d.reset_to_default && (
