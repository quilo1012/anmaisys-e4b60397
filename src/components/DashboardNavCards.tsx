...
const ASSETS = "bg-warning/15 text-warning-strong";
...
export function EngineerNavCards({ assignedCount, stockLow }: { assignedCount?: number; stockLow?: number }) {
  const cards: NavCard[] = [
    { title: "My Tasks", description: "View assigned maintenance orders", url: "/dashboard/engineer", icon: Wrench, badge: assignedCount, accent: "bg-primary/15 text-primary" },
    ...
    { title: "Stock", description: "Spare parts inventory", url: "/dashboard/stock", icon: Package, badge: stockLow, accent: "bg-warning/15 text-warning-strong" },
  ];
  return <DashboardNavCards cards={cards} />;
}
